...
YOUTUBE_FALLBACK_DOWNLOAD_RETRIES = int(env("YOUTUBE_FALLBACK_DOWNLOAD_RETRIES", default=3))
YOUTUBE_FALLBACK_DOWNLOAD_BACKOFF_SECONDS = float(env("YOUTUBE_FALLBACK_DOWNLOAD_BACKOFF_SECONDS", default=2.0))
PIPELINE_RUNNING_STALE_MINUTES = int(env("PIPELINE_RUNNING_STALE_MINUTES", default=180))
